...
const slides: Slide[] = [
  {
    ...
    bigTextClasses: "text-2xl max-w-[900px] leading-[1.4]",
              ...
              >
                <div>
                    ...
                    <div className="grid w-80 items-center grid-cols-3">
                      <div
                        className={`${slide.rangeStyling} w-full ${
                          slide.rangeText >= 1 ? "h-[.3rem]" : "h-[.1rem]"
                        }`}
                      ></div>
                      <div
                        className={`${slide.rangeStyling} w-full ${
                          slide.rangeText >= 2 ? "h-[.3rem]" : "h-[.1rem]"
                        }`}
                      ></div>
                      <div
                        className={`${slide.rangeStyling} w-full ${
                          slide.rangeText >= 3 ? "h-[.3rem]" : "h-[.1rem]"
                        }`}
                      ></div>
                    </div>
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      className={`py-4 px-10 rounded-lg border border-solid ${slide.buttonStyling}`}
                    >
                      Get A Quote
                    </button>
                    <button
                      className={`py-4 px-10 rounded-lg ${slide.secButtonStyling}`}
                    >
